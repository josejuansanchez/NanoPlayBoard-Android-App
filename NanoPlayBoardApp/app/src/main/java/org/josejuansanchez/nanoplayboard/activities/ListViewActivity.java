    ...
    private void loadUIListeners() {
        mListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                ...
                switch (position) {
                    case 0:
                        intent = new Intent(ListViewActivity.this, PotentiometerActivity.class);
                        break;
                    case 1:
                        intent = new Intent(ListViewActivity.this, LDRActivity.class);
                        break;
                    case 2:
                        intent = new Intent(ListViewActivity.this, RGBActivity.class);
                        break;
                    case 3:
                        intent = new Intent(ListViewActivity.this, BuzzerActivity.class);
                        break;
                    case 4:
                        intent = new Intent(ListViewActivity.this, LedMatrixActivity.class);
                        break;
                    case 5:
                        intent = new Intent(ListViewActivity.this, LedMatrixPatternActivity.class);
                        break;
                    case 6:
                        intent = new Intent(ListViewActivity.this, LedMatrixVoiceActivity.class);
                        break;
                }
